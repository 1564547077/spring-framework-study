...
----
Person bean = ...
ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(bean);
----
[source,kotlin,role="secondary"]
.Kotlin
----
...
public class PersonHandler {
	...
	public ServerResponse createPerson(ServerRequest request) throws Exception { // <2>
		Person bean = request.body(Person.class);
	...
	public ServerResponse getPerson(ServerRequest request) { // <3>
		...
		Person bean = repository.getPerson(personId);
		if (bean != null) {
			return ok().contentType(APPLICATION_JSON).body(bean);
		}
		else {
